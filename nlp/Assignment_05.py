...
# Example usage
text_data = """
This document contains various details. Here is a website link: http://example.org/resource. 
An example IP address is: 10.0.0.255. 
Today's date might be 2024-12-01.
A fictional PAN number can be ABCDE1234F.
"""
