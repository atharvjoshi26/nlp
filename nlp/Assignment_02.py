...
# TF-IDF computation
tfidf_model = TfidfModel(g_bow2)  # Create TF-IDF model
tfidf_vectors = [tfidf_model[bow] for bow in g_bow2]  # Apply model to BoW vectors


# Example for simple_preprocess usage with TF-IDF
...
# Compute TF-IDF for preprocessed text
tfidf_model3 = TfidfModel(g_bow3)
tfidf_vectors3 = [tfidf_model3[bow] for bow in g_bow3]
